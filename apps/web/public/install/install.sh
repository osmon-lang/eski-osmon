...
if [ $# -eq 0 ]; then
	osmon_uri="https://github.com/uzinfocom-org/osmon/releases/latest/download/osmon-${target}.zip"
else
	osmon_uri="https://github.com/uzinfocom-org/osmon/releases/download/${1}/osmon-${target}.zip"
fi
